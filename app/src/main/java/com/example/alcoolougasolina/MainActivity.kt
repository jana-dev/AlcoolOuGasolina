...
class MainActivity : AppCompatActivity() {
    ...
    private fun calcularMelhorPreco() {
        ...
        val resultadoValidacao = validarCamposDigitados(precoAlcool, precoGasolina)
        if(resultadoValidacao){
            val precoAlcoolConvertido = precoAlcool.toDouble()
            val precoGasolinaConvertido = precoGasolina.toDouble()
            val resultado = precoAlcoolConvertido / precoGasolinaConvertido
    ...
    private fun validarCamposDigitados(precoAlcool: String, precoGasolina: String): Boolean {
